...
function createNoteElement(id, content) {
    ...
    elementdiv.textContent = content ? content : "Empty Note";
    elementdiv.setAttribute("contenteditable", "true")

    elementdiv.addEventListener("keydown", () => {
        updateNote(id, elementdiv.textContent);
    })
    elementdiv.addEventListener('click', (e) => {
        if (elementdiv.textContent === "Empty Note") {
